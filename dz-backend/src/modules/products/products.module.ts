...
import { ProductUpdatesRepositoryV1Impl } from './repostories/v1/impl/product-updates.repository';
...
@Module({
  ...
  providers: [
    ...
    { provide: ProductUpdatesRepositoryV1, useClass: ProductUpdatesRepositoryV1Impl },
  ],
